...
impl<'a, 'b, Field> Add<&'b CurvePoint<Field>
for &'a CurvePoint<Field>
where Field: FieldImplementation {

    type Output = CurvePoint<Field>;

    fn add(self, other: &'b CurvePoint<Field>) -> CurvePoint<Field> {
